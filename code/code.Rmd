...
T1tibble = tibble(Age, Height, Weight, BMI) %>% rotate_df() 

colnames(T1tibble) = c("Controls","Tetralogy of Fallot", "p-value")
rownames(T1tibble) = c("Age, years", "Weight", "Height", "BMI")
